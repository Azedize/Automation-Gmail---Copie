const gmail_process = {
                    ...
                    "sub_action": [
                        ...
                        {"id":1,"action": "press_keys", "xpath": "//button[.//span[text()='Suivant']] | //button[.//span[text()='Next']]", "wait": 1, "sleep": 5 ,
                            "sub_action": [
                                ...
                                {"action": "check_if_exist", "xpath": "(//a[@aria-label='Try to restore' or @aria-label='Essayer de restaurer']) | (//form//div[contains(text(), 'robot')]) | //div[span and (text()[contains(., 'Impossible de trouver votre compte Google')] or .//font[contains(text(), 'Unable to find your Google account')])]", "wait": 4,"sleep": 0,
                                     "sub_action":[
    ...
    ,
    "return_back":[
        {"action": "dispatchEvent", "xpath": "(//div[@role='button' and (starts-with(@title, 'Retour') or starts-with(@title,'Back') or starts-with(@aria-label, 'Back to') or starts-with(@aria-label, 'Retour'))])[2]", "wait": 5, "sleep": 1 }
    ...
    "google_hotels": [
        ...
        {"action": "check_if_exist", "xpath": "((//div[@role='region' and (@aria-roledescription='carousel' or @aria-roledescription='carrousel') ])[1])/div[2]/div[2]", "wait": 5, "sleep": 0, "sub_action": [
                    {"action": "check_if_exist", "xpath": "//button[.//span[contains(@class, 'fontTitleSmall') and (normalize-space(.)='Hotels' or normalize-space(.)='Hôtels')]]", "wait": 3, "sleep": 0, "sub_action": [
    ...
    "google_trends": [
        {
            ...
            "xpath": "//button[.//*[normalize-space(text())='Sign Up' or normalize-space(text())=\"S'inscrire\"]]",
            "wait": 1,
            "sleep": 5
        },
        {
    ...
    "news_google": [
        {
            "action": "scroll_to_xpath",
            "xpath": "//main/div[2]/c-wiz/section/div[2]/div",
            "wait": 1,
            "sleep": 2
        },
        {
            ...
            "sub_action": [
                {
                    "action": "click_random_link",
                    "container_xpath": "//main/div[2]/c-wiz/section/div[2]/div",
                    "child_selector": "a[href]",
                    "wait": 2,
                    "sleep": 3
                },
            ]
   ...
   "youtube_Shorts": [
    ...
    "CheckLoginYoutube": [
        {"action": "check_if_exist", "xpath": "(//a[starts-with(@href, 'https://accounts.google.com/ServiceLogin')])[1]", "wait": 5, "sleep": 4,  
            "sub_action": [
                {
